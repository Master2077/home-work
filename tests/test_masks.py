...
def test_get_mask_card_number_valid(inp: str, expected: str) -> None:
    assert get_mask_card_number(inp) == expected


@pytest.mark.parametrize(
    "inp",
    ["", "1234", "abcd1234567890", "1234567890abcd"],
)
...
def test_get_mask_account_valid(inp: str, expected: str) -> None:
    assert get_mask_account(inp) == expected


@pytest.mark.parametrize(
    "inp",
    ["", "123", "12ab34", "0000", "*23456"],
)
def test_get_mask_account_invalid(inp: str) -> None:
